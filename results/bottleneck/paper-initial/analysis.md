...
## Key findings
- Highest stable load observed: 250 TPS with bottleneck stage `commit` at p95.
- No overload point was observed in the tested load range.
- Largest commit-stage delay: 250 TPS with p95 commit delay 452.4 ms.
- Highest average CPU load was on `peer0.org1.example.com` at 250 TPS with 85.7% CPU.
- Most timeout-related log activity came from `peer0.org1.example.com` at 250 TPS with 6000 matching log lines.
